...
Deno.serve(async (req) => {
  ...
  if (fields.baseUrl !== undefined) update.base_url = fields.baseUrl;
  if (fields.apiKey !== undefined) update.api_key = fields.apiKey;
  if (fields.availableModels !== undefined) {
    update.available_models = fields.availableModels;
  }
