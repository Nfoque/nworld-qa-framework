// QAAP Settings Screens — SSO, Notifications, Team
...
function SSOScreen({ onNavigate }) {
  ...
  const providers = [
    { name:'Microsoft Azure AD', status:'active', protocol:'SAML 2.0', domain:'techmart.onmicrosoft.com', lastLogin:'Today 14:32', users:24 },
    { name:'Google Workspace', status:'inactive', protocol:'OIDC', domain:'techmart.com', lastLogin:'Never', users:0 },
  ];
...
function NotificationsScreen({ onNavigate }) {
  ...
  const channels = [
    ...
    { id:'slack', name:'Slack', icon:'chat', status:'connected', config:'Connected to TechMart workspace', recipients:2 },
    { id:'teams', name:'Microsoft Teams', icon:'chat', status:'not_configured', config:null, recipients:0 },
    { id:'webhook', name:'Webhook', icon:'connectors', status:'connected', config:'https://hooks.techmart.com/qa-alerts', recipients:1 },
...
function TeamScreen({ onNavigate }) {
  ...
  const members = [
    { name:'Elena García', email:'elena.garcia@techmart.com', role:'Admin', status:'active', lastActive:'Just now', initials:'EG' },
    { name:'Carlos Ruiz', email:'carlos.ruiz@techmart.com', role:'QA Expert', status:'active', lastActive:'2h ago', initials:'CR' },
    { name:'Marta López', email:'marta.lopez@techmart.com', role:'QA Expert', status:'active', lastActive:'1d ago', initials:'ML' },
    { name:'David Chen', email:'david.chen@techmart.com', role:'Viewer', status:'active', lastActive:'3d ago', initials:'DC' },
    { name:'Sophie Martin', email:'sophie.martin@techmart.com', role:'QA Expert', status:'pending', lastActive:'Invited', initials:'SM' },
  ];
