...
1. Read `documentation/adr/06-decision-rules.md` for the scope hierarchy and rule of 3.
...
4. Before creating, verify the component doesn't already exist at the target path.

5. Ask the user if this component is used by 3+ consumers (rule of 3 check). If not, suggest keeping it inside the feature that uses it instead of creating a shared component.
...
7. Report what was created, including the full import path for consumers.
